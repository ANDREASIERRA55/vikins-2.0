...
class VikingTest {
    ...
    public void should_inherit_from_Soldier() {
     ...
     @Test
     public void should_receive_3_arguments() { assertNotNull(viking);}


     @Test
     public void should_receive_the_health_property_as_its_1st_argument() {assertEquals("Harald", viking.name);}

     @Test
     public void should_receive_the_health_property_as_its_2st_argument() {assertEquals(300, viking.health);}

     @Test
     public void should_receive_the_health_property_as_its_3st_argument() {assertEquals(150, viking.strength);}

     @Test
     public void attack_should_return_strength_property_of_the_Saxon() {
        int resultAttack = viking.attack(50);
